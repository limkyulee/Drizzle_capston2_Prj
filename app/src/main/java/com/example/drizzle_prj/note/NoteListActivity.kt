...
class NoteListActivity : AppCompatActivity() {
    ...
    var arrayList_details:ArrayList<noteModel> = ArrayList();
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView_details = findViewById<ListView>(R.id.listViewNote) as ListView
        run("http://43.201.88.75/notelist.php")
    }
    fun run(url: String) {
...
//                 progress.visibility = View.GONE
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                //creating json array
                var jsonarray_info: JSONArray = json_contact.getJSONArray("noteList")
                ...
                runOnUiThread {
                    ...
                    val obj_adapter : NoteCustomAdapter
                    obj_adapter = NoteCustomAdapter(applicationContext,arrayList_details)
